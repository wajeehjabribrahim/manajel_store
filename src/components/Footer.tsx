    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-lg font-black mb-4 tracking-wide text-[#C9A66B]">
              <Link href="/" title="مناجل — زيت زيتون فلسطيني بكر ممتاز">
                {(t as any).footer.brandName}
              </Link>
            </h3>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center text-xs text-black/70 gap-4 pb-20">
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.instagram.com/manajel.ps" target="_blank" rel="noopener noreferrer" className="opacity-100 hover:opacity-80" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
