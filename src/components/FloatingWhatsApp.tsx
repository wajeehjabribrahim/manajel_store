...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-[70] inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/20 shadow-lg transition-transform duration-200 hover:scale-105 md:bottom-6 md:right-6"
      style={{
