  ...
  return (
    <div className="bg-[#FBF8F2] text-[#121416] tajawal-regular-all">
      ...
      <section
        ...
        className="text-[#121416] py-12 sm:py-20 px-4"
      >
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10 sm:mb-12">
          <AnimatedSection animationType="fade-left">
            ...
            <p className="text-[13px] sm:text-base text-black/80 mb-4 leading-relaxed">
              {t.about.storyPara1}
            </p>
            <p className="text-[13px] sm:text-base text-black/80 mb-4 leading-relaxed">
              {t.about.storyPara2}
            ...
            <p className="text-[13px] sm:text-base text-black/80 leading-relaxed">
              {t.about.storyPara4}
            </p>
          </AnimatedSection>
          <AnimatedSection animationType="fade-right" delay={100}>
            <div
              className="rounded-xl border border-black/10 bg-[#FFFFFF] p-6 sm:p-8 flex flex-col justify-center"
            >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    ...
                    <span className="text-[13px] sm:text-base text-black/80">{value}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <AnimatedSection animationType="fade-up">
          <div className="mb-16">
            ...
            <p className="text-center text-black/70 text-sm sm:text-base mb-8">
              {language === "ar" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
              {[
                ...
                <div
                  key={i}
                  className={`group h-full rounded-lg border border-[#C9A66B]/40 bg-[#FFFFFF]/60 p-4 sm:p-5 backdrop-blur-sm transition-all duration-300 hover:border-[#C9A66B]/70 hover:bg-[#FFFFFF] hover:shadow-lg hover:shadow-[#C9A66B]/20 text-center ${language === "ar" ? "sm:text-right" : "sm:text-left"}`}
                >
                  <div className="mb-3 flex items-start justify-between gap-2">
                    <h4 className="flex-1 text-sm sm:text-base font-bold leading-6 text-[#121416] transition-colors group-hover:text-[#C9A66B] line-clamp-2">
                      {product.name}
                    </h4>
                    <span className="mt-0.5 shrink-0 text-lg text-[#C9A66B]">✓</span>
                  </div>
                  <p className="text-xs sm:text-sm text-black/60 leading-7 line-clamp-3">
                    {product.desc}
                  </p>
                </div>
              ))}
        ...
        <AnimatedSection animationType="scale" delay={200}>
          <div
            className="rounded-xl border border-black/10 bg-[#FFFFFF] p-6 sm:p-12 text-center"
          >
            
            <p className="text-[13px] sm:text-base text-black/80 mb-6">
              {t.about.contactDesc}
            </p>
            <Link
              href="/store/contact"
