    ...
    <div className="bg-[#FBF8F2] text-[#121416] tajawal-regular-all" style={{ direction: dir, minHeight: "calc(100vh - 200px)" }}>
      <div className="mx-auto max-w-md px-4 py-12">
        <div className="rounded-2xl border border-black/10 bg-[#FFFFFF] p-6 shadow-md">
          ...
          <h1 className="mb-2 text-3xl font-bold text-[#121416]">{t("auth.titleLogin")}</h1>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`hide-native-password-toggle w-full rounded-lg border px-3 py-2 ${dir === "rtl" ? "pl-10" : "pr-10"} text-[#121416] focus:outline-none focus:ring-2 focus:ring-[#C9A66B]/40`}
                  style={{ borderColor: "rgba(0,0,0,0.25)", backgroundColor: "#FFFFFF" }}
                  required
                />
                <button
                  ...
                  className={`absolute inset-y-0 ${dir === "rtl" ? "left-2" : "right-2"} flex items-center text-black/70 hover:text-[#121416]`}
