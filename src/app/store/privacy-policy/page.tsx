  ...
  return (
    <div className="bg-[#FBF8F2] text-[#121416] tajawal-regular-all">
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8 rounded-xl border border-black/10 bg-[#FFFFFF] p-5 sm:p-6 md:p-8 text-sm sm:text-base">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold mb-4 text-[#C9A66B]">
              {t.policies.privacyMatters}
            </h2>
            <p className="text-black/80 text-sm sm:text-base mb-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-black/80 text-sm sm:text-base space-y-2">
              <li>
          ...
          <div>
            ...
            <p className="text-black/80 text-sm sm:text-base mb-3">
          ...
          <div>
            ...
            <p className="text-black/80 text-sm sm:text-base mb-3">{t.policies.rightsDesc}</p>
            <ul className="list-disc list-inside text-black/80 text-sm sm:text-base space-y-2">
          ...
          <div
            className="rounded-lg border border-[#C9A66B]/35 bg-[#FFFFFF] p-6"
          >
            <h3 className="text-lg sm:text-xl font-bold mb-3 text-[#C9A66B]">
          ...
          <p className="text-black/55 text-xs sm:text-sm">
